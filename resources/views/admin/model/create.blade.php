...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i>  MODEL DETAILS</h1>
        </div>
    </div>
    <div id="error"></div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title text-info" id="exampleModalCenterTitle">Add Model</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                {!! Form::open(['route' => 'model.store','class'=>'form-horizontal modelValidation','id'=>'modelAddForm','name'=>'modelAddForm']) !!}
                <div class="modal-body">
                  ...
                  ?>
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-3"> Model Name<strong style="color:red">*</strong>
                            </label>
                            <div class="col-md-8">
            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="table-responsive">
                        ...
                        <div class="button">
                            <button title="Add Brand" data-toggle="modal" data-target="#add-brand" class="button btn-lg shadow mb-5 rounded" style="background-color: #f24c15;">Add Model </button>
                        </div>
                    </div>
                </div>
            </div>
